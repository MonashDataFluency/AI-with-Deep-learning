...
def model_calibration(logits_file, M=15):
    ...
    # Task 2-1: Learn the temperature with validation set with TemperatureScaling's fit method
    ##################################
    scaler = TemperatureScaling()
    scaler.fit(y_logits_val, y_val)
    ##################################

    # Task 2-2: Conduct model calibration with learnt temperature with TemperatureScaling's predict method
    ##################################
